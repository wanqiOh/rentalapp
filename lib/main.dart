...
import 'package:rentalapp/provider/customer_state.dart';
import 'package:rentalapp/repository/notifications_repository.dart';
...
void main() async {
  ...
  runApp(EasyLocalization(
    child: MultiProvider(
      providers: [
        ListenableProvider<CustomerState>(create: (_) => CustomerState()),
      ],
      child: MyApp(),
    ),
    supportedLocales: [
