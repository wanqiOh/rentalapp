...
import 'package:rentalapp/model/view_model/invoice.dart';
import 'package:rentalapp/repository/pdf_repository.dart';
...
class PdfInvoiceRepository {
  ...
  static Widget buildSupplierAddress(CompanyItem supplier) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
  ...
  static Widget buildInvoice(Invoice invoice) {
    ...
    final data = invoice.items.map((item) {
      final total = globals.tmpOrder.getTotalRentingPrice();

      return [
        item.machineName,
        formatDate(globals.tmpOrder.startDate),
        '${globals.tmpOrder.orderQuantity}',
  ...
  static Widget buildTotal(Invoice invoice) {
    final netTotal = globals.tmpOrder.getTotalRentingPrice();
    final vatPercent = globals.tax;
    final vat = globals.tmpOrder.getTaxCharge();
    final total = globals.tmpOrder.getTotalRentCharge();
